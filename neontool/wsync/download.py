...
class UrlDownload(object):
    ...
    def execute(self):
        ...
        print "The main html file has been download to %s, before download refrence resources, you can handle this file." % os.path.abspath(os.path.join(self.orginFolder, self.mainpage))
